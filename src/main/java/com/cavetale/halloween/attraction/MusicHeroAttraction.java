...
public final class MusicHeroAttraction extends Attraction<MusicHeroAttraction.SaveTag> {
    ...
    @Getter protected final Component displayName = Component.text("Music Hero", NamedTextColor.RED);
    ...
    enum State {
        IDLE,
        PLAY {
            @Override protected State tick(MusicHeroAttraction instance) {
        ...
        protected State tick(MusicHeroAttraction instance) {
            return null;
        }
    }
